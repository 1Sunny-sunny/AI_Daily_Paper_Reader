...
title_zh: 灵长类IT皮层和深度网络中朝向编码的重新出现揭示了视觉处理的功能中枢
...
tldr: 本研究质疑高效编码假说，通过猕猴fMRI与MVPA发现方向编码沿腹侧视觉流从V1重新出现于IT皮层，且IT中多类别响应体素整合方向信息并增强连接，形成功能枢纽。该现象推广至深度神经网络，揭示方向重呈现为功能多样性与连接的计算副产品，提示枢纽神经元支持整合视觉处理。
source: biorxiv
selection_source: fresh_fetch
motivation: 验证高效编码原则是否预测方向特征不在高级视觉皮层冗余编码。
method: 采用功能磁共振成像(fMRI)和多体素模式分析(MVPA)，在猕猴观看全视野光栅时量化全视觉流方向表征。
result: 方向信息从V1到IT持续存在，IT中多类别响应体素携带更多方向信息且呈现更强内部及上游连接，构成功能枢纽。
conclusion: 方向在IT皮层重新出现并非冗余，而是功能多样性和增强连接的计算产物，提示枢纽神经元支撑灵活、整合的视觉加工。
---

## 摘要
灵长类视觉系统是一个由多个脑区组成的层次化网络，能够将视网膜输入转化为丰富的知觉。根据高效神经编码原则，基本的视觉特征（如朝向）已经在早期视觉区域中得到表征，不应在更高级的区域（如V4和下颞叶皮层IT）中被冗余编码。我们通过功能磁共振成像和多元体素模式分析，在观看全场光栅的猕猴身上量化了整个视觉流中的朝向表征，从而检验了这一假设。与高效编码的预测相反，我们发现从V1到IT皮层的整个腹侧视觉流中都存在稳健的朝向信息。朝向信息分布在皮层空间和表征空间中，尤其是在IT区域。对面孔、物体和身体有多元响应的体素比高度类别选择性的体素携带更多的朝向信息。它们还在IT内部以及与上游区域V1-V4之间表现出更强的连接性。这些发现表明存在功能性的“中枢”，它们通过增强的连接性整合低级和高级特征。这一现象推广到了与大脑高度相似的深度卷积神经网络模型中，突显了类似中枢的单元在处理复杂输入的层次化过程中的重要性。总之，我们的结果表明，IT皮层中朝向的重新出现并非通过冗余，而是功能多样性和连接性的计算副产品，提示存在“中枢”神经元，这些神经元可能支持超越物体识别的灵活、整合性视觉处理。
